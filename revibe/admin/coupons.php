...
?>
            ...
            <button type="button" id="toggle-coupon-form" class="btn btn-primary" style="margin-bottom: var(--space-8);"><?php echo $edit ? 'Formular schließen' : 'Neuen Coupon erstellen'; ?></button>

            <div id="coupon-form-wrapper" style="display: <?php echo $edit ? 'block' : 'none'; ?>;">
...
<script>
(function() {
    var toggle = document.getElementById('toggle-coupon-form');
    var wrapper = document.getElementById('coupon-form-wrapper');
    if (toggle && wrapper) {
        toggle.addEventListener('click', function() {
            var isHidden = wrapper.style.display === 'none';
            wrapper.style.display = isHidden ? 'block' : 'none';
            toggle.textContent = isHidden ? 'Formular schließen' : 'Neuen Coupon erstellen';
        });
    }
})();
</script>
