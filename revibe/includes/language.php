...
function getTranslations($lang = null) {
    ...
    $translations = [
        ...
        'en' => [
            ...
            'admin_offer_email_body' => "Hello {name},\n\nthank you for your inquiry. Please find your non-binding offer attached.\n\nYou can also view, accept or decline the offer online:\n{link}\n\nThe offer is valid until {valid_until}.\n\nBest regards\n{company}",
            'admin_invoice_email_body' => "Hello {name},\n\nthank you for accepting our offer. Please find your invoice attached.\n\nPlease transfer the amount within 14 days to the account stated in the invoice.\n\nBest regards\n{company}",
