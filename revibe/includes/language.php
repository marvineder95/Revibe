...
function getTranslations($lang = null) {
    ...
    $translations = [
        ...
        'de' => [
            ...
            'meta_title_reviews' => 'Bewertungen | Revibe',
            'meta_description_reviews' => 'Lesen Sie Erfahrungsberichte und Bewertungen unserer Kunden. Teilen Sie Ihre eigenen Eindrücke von Revibe.',
            ...
            // Hero
            'hero_label' => 'Jukebox & Co.-Verleih',
            'hero_title' => 'Jukebox und Co. mieten',
            ...
            'add_to_inquiry_short' => 'Hinzufügen',
            'remove_from_inquiry' => 'Zum Warenkorb',
            ...
            'process_step_5_text' => 'Lehnen Sie sich zurück und genießen Sie mit Ihren Gästen die beste Musik und Atmosphäre.',
            ...
            'footer_credit_text' => 'Design und Entwicklung von',
            'footer_social_text' => 'Folgen Sie uns für Updates, Events und mehr Einblicke.',
            'footer_feature_1' => 'Hochwertige Jukeboxen',
            'footer_feature_2' => 'Originaler Vinyl-Sound',
            'footer_feature_3' => 'Lieferung & Aufbau',
            'footer_feature_4' => 'Sicher & zuverlässig',
            ...
            'catalog_results_count' => '{count} Ergebnisse',
            'catalog_results_count_one' => '1 Ergebnis',
            'catalog_availability_hidden' => '{count} weitere Jukeboxen sind im gewählten Zeitraum bereits reserviert.',
            'catalog_availability_hidden_one' => '1 weitere Jukebox ist im gewählten Zeitraum bereits reserviert.',
            'catalog_empty_no_availability' => 'Für den gewählten Zeitraum sind leider keine Jukeboxen mehr verfügbar. Bitte ändern Sie den Mietzeitraum oder setzen Sie die Filter zurück.',
            ...
            'detail_feature_vinyl' => 'Original Vinyl Sound',
            'detail_feature_serviced' => 'Gewartet & geprüft',
            'detail_feature_delivery' => 'Lieferung möglich',
            'detail_feature_insured' => 'Versichert',
            ...
            'process_eyebrow' => 'SO EINFACH GEHT\'S',
            'process_main_title' => 'In 6 Schritten zu Ihrem perfekten Event',
            'process_main_subtitle' => 'Wir haben den Mietprozess so einfach wie möglich gestaltet. Von der Idee bis zum unvergesslichen Event – wir sind für Sie da.',
            'process_cta_title' => 'Bereit für Ihr Event?',
            'process_cta_text' => 'Sichern Sie sich jetzt Ihre Jukebox und machen Sie Ihr Event unvergesslich.',
            'process_cta_button' => 'Jetzt Anfrage starten',
            ...
            'admin_tags' => 'Tags',
            'admin_tags_filter' => 'Nach Tags filtern',
            'admin_tags_filter_all' => 'Alle Tags',
            'jukebox_tag_fully_functional' => 'voll funktionsfähig',
            'jukebox_tag_lights_work' => 'Leuchtelemente funktionieren',
            'jukebox_tag_lights_broken' => 'Leuchtelemente funktionieren nicht',
            'jukebox_tag_playback_broken' => 'Abspielen Vinyl/CD funktioniert nicht',
            'jukebox_tag_decorative' => 'Dekoartikel',
            ...
            'admin_download_pdf' => 'Download',
            'admin_mark_paid' => 'Als bezahlt markieren',
            'admin_send_invoice' => 'Rechnung senden',
            'admin_send_invoice_confirm' => 'Rechnung an den Kunden senden?',
            'admin_success_invoice_sent' => 'Rechnung wurde an den Kunden gesendet.',
            'admin_error_invoice_send' => 'Rechnung konnte nicht gesendet werden.',
            'admin_error_invoice_not_found' => 'Rechnung nicht gefunden.',
            ...
            'admin_inquiries_without_offer_title' => 'Anfragen ohne Angebot',
            'admin_no_inquiries_without_offer' => 'Keine Anfragen ohne Angebot vorhanden.',
            'admin_inquiry_dates' => 'Mietzeitraum',
            'admin_inquiry_address' => 'Veranstaltungsort',
            'admin_inquiry_days' => 'Tage',
            'admin_create_offer' => 'Angebot erstellen',
            'admin_create_offer_confirm' => 'Angebot erstellen und per E-Mail an den Kunden senden?',
            'admin_success_offer_created' => 'Angebot wurde erstellt und an den Kunden gesendet.',
            'admin_error_offer_create' => 'Angebot konnte nicht erstellt werden.',
            'admin_create_offer_manual_title' => 'Angebot manuell erstellen',
            'admin_create_offer_manual_button' => 'Neues Angebot erstellen',
            'admin_create_offer_manual_heading' => 'Manuelles Angebot für einen Kunden erstellen',
            'admin_customer_data' => 'Kundendaten',
            'admin_event_address' => 'Veranstaltungsadresse',
            'admin_event_street' => 'Straße',
            'admin_event_housenumber' => 'Hausnummer',
            'admin_event_zip' => 'PLZ',
            'admin_event_city' => 'Ort',
            'admin_event_country' => 'Land',
            'admin_event_country_other' => 'Anderes Land',
            'admin_event_country_other_label' => 'Land (sonstiges)',
            'admin_select_jukeboxes' => 'Jukeboxen auswählen',
            'admin_rental_dates' => 'Mietzeitraum',
            'admin_date_start' => 'Mietbeginn',
            'admin_date_end' => 'Mietende',
            'admin_create_offer_submit' => 'Angebot erstellen & per E-Mail senden',
            'admin_create_invoice' => 'Rechnung erstellen',
            'admin_create_invoice_confirm' => 'Rechnung für dieses Angebot erstellen?',
            'admin_view_invoice_pdf' => 'Rechnung ansehen',
            'admin_success_invoice_created' => 'Rechnung wurde erfolgreich erstellt.',
            'admin_error_invoice_create' => 'Rechnung konnte nicht erstellt werden.',
            'admin_error_invoice_exists' => 'Für dieses Angebot existiert bereits eine Rechnung.',
            'admin_back_to_offers' => 'Zurück zu den Angeboten',
            'admin_jukebox_name' => 'Jukebox',
            'admin_jukebox_price_day' => 'Preis/Tag',
            'admin_no_jukeboxes' => 'Keine Jukeboxen vorhanden.',
            'admin_error_create_offer' => 'Bitte korrigieren Sie die folgenden Fehler',
            'admin_error_create_offer_dates' => 'Bitte wählen Sie einen gültigen Mietzeitraum aus.',
            'admin_error_create_offer_past_dates' => 'Mietbeginn und Mietende dürfen nicht in der Vergangenheit liegen.',
            'admin_error_create_offer_date_order' => 'Das Mietende muss nach dem Mietbeginn liegen.',
            'admin_error_create_offer_no_jukebox' => 'Bitte wählen Sie mindestens eine Jukebox aus.',
            'admin_error_create_offer_inquiry' => 'Anfrage konnte nicht gespeichert werden.',
            'admin_positions_title' => 'Zusätzliche Positionen',
            'admin_position_add' => 'Position hinzufügen',
            'admin_position_text' => 'Freitext',
            'admin_position_unit' => 'Einheit (€ netto)',
            'admin_position_quantity' => 'Menge',
            'admin_position_remove' => 'Entfernen',
            ...
            'admin_offer_email_body' => "<p>Hallo {name},</p><p>vielen Dank für Ihre Anfrage. Im Anhang finden Sie Ihr unverbindliches Angebot.</p><p>Sie können das Angebot auch online einsehen und direkt annehmen oder ablehnen:</p><p><a href=\"{offer_link}\" style=\"color:#0066B1;text-decoration:underline;font-weight:600;\">{offer_link}</a></p><p>Das Angebot ist gültig bis {valid_until}.</p><p>Mit freundlichen Grüßen<br><strong>{company} Team</strong></p>",
            ...
            // Reviews Admin
            'admin_reviews_title' => 'Bewertungen verwalten',
            'admin_reviews_date' => 'Datum',
            'admin_reviews_author' => 'Autor',
            'admin_reviews_rating' => 'Bewertung',
            'admin_reviews_title_label' => 'Titel',
            'admin_reviews_text' => 'Text',
            'admin_reviews_status' => 'Status',
            'admin_reviews_status_pending' => 'Ausstehend',
            'admin_reviews_status_approved' => 'Freigegeben',
            'admin_reviews_status_rejected' => 'Abgelehnt',
            'admin_reviews_actions' => 'Aktionen',
            'admin_reviews_approve' => 'Freigeben',
            'admin_reviews_reject' => 'Ablehnen',
            'admin_reviews_delete' => 'Löschen',
            'admin_reviews_delete_confirm' => 'Möchten Sie diese Bewertung wirklich löschen?',
            'admin_reviews_no_reviews' => 'Keine Bewertungen vorhanden.',
            'admin_reviews_all' => 'Alle',
            'admin_reviews_filter_status' => 'Nach Status filtern',
            'admin_reviews_success_approved' => 'Bewertung freigegeben.',
            'admin_reviews_success_rejected' => 'Bewertung abgelehnt.',
            'admin_reviews_success_deleted' => 'Bewertung gelöscht.',
            'admin_reviews_error_action' => 'Aktion konnte nicht ausgeführt werden.',
            ...
            'offer_success_accepted' => 'Vielen Dank! Wir freuen uns, dass Sie unser Angebot angenommen haben. Wir prüfen nun alles und melden uns mit einem genauen Termin und allen weiteren Informationen bei Ihnen.',
            ...
            'offer_signature_label' => 'Bitte unterschreiben Sie zur Annahme des Angebots:',
            'offer_signature_clear' => 'Unterschrift löschen',
            'offer_signature_required' => 'Bitte geben Sie eine Unterschrift ein, um das Angebot anzunehmen.',
            'admin_show_signature' => 'Unterschrift anzeigen',
            'admin_signature_alt' => 'Kundenunterschrift',
            ...
            'request_contract_fee_hint' => 'Bei der Vermietung von beweglichen Sachen (z. B. Jukeboxen) unterliegt der Bestandvertrag gemäß § 33 Tarifpunkt 5 Gebührengesetz 1957 (GebG) einer Vertragsgebühr von 1 % der vereinbarten Bruttomiete. Diese staatliche Gebühr wird an das Finanzamt abgeführt.',
            ...
            'reviews_subtitle' => 'Was Kunden über Revibe sagen',
            'reviews_intro' => 'Ihre Meinung ist uns wichtig. Teilen Sie Ihre Erfahrungen und helfen Sie anderen bei der Auswahl.',
            'reviews_form_title' => 'Bewertung abgeben',
            'reviews_form_toggle' => 'Bewertung abgeben',
            'reviews_form_name' => 'Ihr Name *',
            'reviews_form_name_placeholder' => 'Max Mustermann',
            'reviews_form_rating' => 'Ihre Bewertung *',
            'reviews_form_rating_label' => 'Sterne',
            'reviews_form_review_title' => 'Titel (optional)',
            'reviews_form_review_title_placeholder' => 'Überschrift Ihrer Bewertung',
            'reviews_form_text' => 'Ihre Bewertung *',
            'reviews_form_text_placeholder' => 'Teilen Sie Ihre Erfahrungen mit Revibe ...',
            'reviews_form_privacy' => 'Ich stimme der Veröffentlichung meiner Bewertung zu. *',
            'reviews_form_submit' => 'Bewertung absenden',
            'reviews_success_title' => 'Vielen Dank!',
            'reviews_success_message' => 'Ihre Bewertung wurde eingereicht und wird nach Prüfung veröffentlicht.',
            'reviews_error_title' => 'Es ist ein Fehler aufgetreten',
            'reviews_error_message' => 'Bitte überprüfen Sie Ihre Eingaben und versuchen Sie es erneut.',
            'reviews_error_rate_limit' => 'Sie haben zu viele Bewertungen in kurzer Zeit abgegeben. Bitte versuchen Sie es später erneut.',
            'reviews_empty' => 'Noch keine Bewertungen vorhanden. Seien Sie die erste Person, die eine Bewertung abgibt.',
            'reviews_average' => 'Durchschnittsbewertung',
            'reviews_count' => '{count} Bewertungen',
            'reviews_count_one' => '1 Bewertung',
            'reviews_verified' => 'Verifizierter Kunde',
            'reviews_pending_notice' => 'Nach der Freigabe durch unser Team erscheint Ihre Bewertung hier.',
        ],
        ...
        'en' => [
            ...
            'meta_title_reviews' => 'Reviews | Revibe',
            'meta_description_reviews' => 'Read testimonials and reviews from our customers. Share your own experience with Revibe.',
            ...
            // Hero
            'hero_label' => 'Jukebox & Co. Rental',
            'hero_title' => 'Rent Jukebox & Co.',
            ...
            'add_to_inquiry_short' => 'Add',
            'remove_from_inquiry' => 'To Cart',
            ...
            'process_step_5_text' => 'Sit back and enjoy the best music and atmosphere with your guests.',
            'process_step_6_number' => '06',
            ...
            'footer_credit_text' => 'Design and development by',
            'footer_social_text' => 'Follow us for updates, events and more insights.',
            'footer_feature_1' => 'High-quality jukeboxes',
            'footer_feature_2' => 'Original vinyl sound',
            'footer_feature_3' => 'Delivery & setup',
            'footer_feature_4' => 'Safe & reliable',
            ...
            'catalog_results_count' => '{count} results',
            'catalog_results_count_one' => '1 result',
            'catalog_availability_hidden' => '{count} more jukeboxes are already reserved for the selected period.',
            'catalog_availability_hidden_one' => '1 more jukebox is already reserved for the selected period.',
            'catalog_empty_no_availability' => 'No jukeboxes are available for the selected period. Please change the rental period or reset the filters.',
            ...
            'detail_feature_vinyl' => 'Original Vinyl Sound',
            'detail_feature_serviced' => 'Serviced & Checked',
            'detail_feature_delivery' => 'Delivery Possible',
            'detail_feature_insured' => 'Insured',
            ...
            'process_eyebrow' => 'SO EASY IT WORKS',
            'process_main_title' => 'In 6 Steps to Your Perfect Event',
            'process_main_subtitle' => 'We have made the rental process as simple as possible. From idea to unforgettable event – we are here for you.',
            'process_cta_title' => 'Ready for Your Event?',
            'process_cta_text' => 'Secure your jukebox now and make your event unforgettable.',
            'process_cta_button' => 'Start Inquiry Now',
            ...
            'admin_tags' => 'Tags',
            'admin_tags_filter' => 'Filter by tags',
            'admin_tags_filter_all' => 'All tags',
            'jukebox_tag_fully_functional' => 'fully functional',
            'jukebox_tag_lights_work' => 'lighting elements work',
            'jukebox_tag_lights_broken' => 'lighting elements do not work',
            'jukebox_tag_playback_broken' => 'Vinyl/CD playback does not work',
            'jukebox_tag_decorative' => 'decorative item',
            ...
            'admin_send_invoice' => 'Send invoice',
            'admin_send_invoice_confirm' => 'Send invoice to customer?',
            'admin_success_invoice_sent' => 'Invoice has been sent to the customer.',
            'admin_error_invoice_send' => 'Invoice could not be sent.',
            'admin_error_invoice_not_found' => 'Invoice not found.',
            ...
            'admin_inquiries_without_offer_title' => 'Inquiries without offer',
            'admin_no_inquiries_without_offer' => 'No inquiries without offer available.',
            'admin_inquiry_dates' => 'Rental period',
            'admin_inquiry_address' => 'Event location',
            'admin_inquiry_days' => 'days',
            'admin_create_offer' => 'Create offer',
            'admin_create_offer_confirm' => 'Create offer and send it to the customer by email?',
            'admin_success_offer_created' => 'Offer created and sent to the customer.',
            'admin_error_offer_create' => 'Offer could not be created.',
            'admin_create_offer_manual_title' => 'Create offer manually',
            'admin_create_offer_manual_button' => 'Create new offer',
            'admin_create_offer_manual_heading' => 'Create manual offer for a customer',
            'admin_customer_data' => 'Customer data',
            'admin_event_address' => 'Event address',
            'admin_event_street' => 'Street',
            'admin_event_housenumber' => 'House number',
            'admin_event_zip' => 'ZIP',
            'admin_event_city' => 'City',
            'admin_event_country' => 'Country',
            'admin_event_country_other' => 'Other country',
            'admin_event_country_other_label' => 'Country (other)',
            'admin_select_jukeboxes' => 'Select jukeboxes',
            'admin_rental_dates' => 'Rental period',
            'admin_date_start' => 'Rental start',
            'admin_date_end' => 'Rental end',
            'admin_create_offer_submit' => 'Create offer & send by email',
            'admin_create_invoice' => 'Create invoice',
            'admin_create_invoice_confirm' => 'Create invoice for this offer?',
            'admin_view_invoice_pdf' => 'View invoice',
            'admin_success_invoice_created' => 'Invoice created successfully.',
            'admin_error_invoice_create' => 'Invoice could not be created.',
            'admin_error_invoice_exists' => 'An invoice already exists for this offer.',
            'admin_back_to_offers' => 'Back to offers',
            'admin_jukebox_name' => 'Jukebox',
            'admin_jukebox_price_day' => 'Price/day',
            'admin_no_jukeboxes' => 'No jukeboxes available.',
            'admin_error_create_offer' => 'Please correct the following errors',
            'admin_error_create_offer_dates' => 'Please select a valid rental period.',
            'admin_error_create_offer_past_dates' => 'Rental start and end must not be in the past.',
            'admin_error_create_offer_date_order' => 'The rental end must be after the rental start.',
            'admin_error_create_offer_no_jukebox' => 'Please select at least one jukebox.',
            'admin_error_create_offer_inquiry' => 'Inquiry could not be saved.',
            'admin_positions_title' => 'Additional items',
            'admin_position_add' => 'Add item',
            'admin_position_text' => 'Description',
            'admin_position_unit' => 'Unit price (€ net)',
            'admin_position_quantity' => 'Quantity',
            'admin_position_remove' => 'Remove',
            ...
            'admin_offer_email_body' => "<p>Hello {name},</p><p>thank you for your inquiry. Please find your non-binding offer attached.</p><p>You can also view the offer online and accept or decline it directly:</p><p><a href=\"{offer_link}\" style=\"color:#0066B1;text-decoration:underline;font-weight:600;\">{offer_link}</a></p><p>The offer is valid until {valid_until}.</p><p>Best regards<br><strong>{company} Team</strong></p>",
            ...
            'admin_reviews_author' => 'Author',
            'admin_reviews_rating' => 'Rating',
            'admin_reviews_title_label' => 'Title',
            'admin_reviews_text' => 'Text',
            'admin_reviews_status' => 'Status',
            'admin_reviews_status_pending' => 'Pending',
            'admin_reviews_status_approved' => 'Approved',
            'admin_reviews_status_rejected' => 'Rejected',
            'admin_reviews_actions' => 'Actions',
            'admin_reviews_approve' => 'Approve',
            'admin_reviews_reject' => 'Reject',
            'admin_reviews_delete' => 'Delete',
            'admin_reviews_delete_confirm' => 'Do you really want to delete this review?',
            'admin_reviews_no_reviews' => 'No reviews available.',
            'admin_reviews_all' => 'All',
            'admin_reviews_filter_status' => 'Filter by status',
            'admin_reviews_success_approved' => 'Review approved.',
            'admin_reviews_success_rejected' => 'Review rejected.',
            'admin_reviews_success_deleted' => 'Review deleted.',
            'admin_reviews_error_action' => 'Action could not be performed.',
            ...
            'offer_success_accepted' => 'Thank you! We are delighted that you have accepted our offer. We will now review everything and get back to you with an exact date and all further information.',
            ...
            'offer_signature_label' => 'Please sign to accept the offer:',
            'offer_signature_clear' => 'Clear signature',
            'offer_signature_required' => 'Please provide a signature to accept the offer.',
            'admin_show_signature' => 'Show signature',
            'admin_signature_alt' => 'Customer signature',
            ...
            'request_contract_fee_hint' => 'When renting tangible goods (e.g. jukeboxes), the rental agreement is subject to a contract fee of 1% of the agreed gross rent pursuant to § 33 Tarifpunkt 5 of the Austrian Fees Act 1957 (GebG). This statutory fee is paid to the tax office.',
            ...
            'reviews_subtitle' => 'What customers say about Revibe',
            'reviews_intro' => 'Your opinion matters. Share your experience and help others choose.',
            'reviews_form_title' => 'Write a Review',
            'reviews_form_toggle' => 'Write a Review',
            'reviews_form_name' => 'Your Name *',
            'reviews_form_name_placeholder' => 'John Doe',
            'reviews_form_rating' => 'Your Rating *',
            'reviews_form_rating_label' => 'Stars',
            'reviews_form_review_title' => 'Title (optional)',
            'reviews_form_review_title_placeholder' => 'Headline for your review',
            'reviews_form_text' => 'Your Review *',
            'reviews_form_text_placeholder' => 'Share your experience with Revibe ...',
            'reviews_form_privacy' => 'I agree to the publication of my review. *',
            'reviews_form_submit' => 'Submit Review',
            'reviews_success_title' => 'Thank You!',
            'reviews_success_message' => 'Your review has been submitted and will be published after approval.',
            'reviews_error_title' => 'An Error Occurred',
            'reviews_error_message' => 'Please check your entries and try again.',
            'reviews_error_rate_limit' => 'You have submitted too many reviews in a short time. Please try again later.',
            'reviews_empty' => 'No reviews yet. Be the first to leave a review.',
            'reviews_average' => 'Average Rating',
            'reviews_count' => '{count} reviews',
            'reviews_count_one' => '1 review',
            'reviews_verified' => 'Verified Customer',
            'reviews_pending_notice' => 'Your review will appear here after approval by our team.',
        ]
    ];
